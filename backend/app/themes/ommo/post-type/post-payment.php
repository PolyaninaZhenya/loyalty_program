<?php
/**
 * Регистрация новой таксономии payment
 */
add_action('init', 'create_taxonomy_payment');
function create_taxonomy_payment()
{
    // список параметров: wp-kama.ru/function/get_taxonomy_labels
    register_taxonomy('cat_payment', ['payment'], [
        ...
        'graphql_single_name' => 'cat_payment',
        'graphql_plural_name' => 'cat_payments',
...
/**
 * Регистрация нового типа поста payment
 */
...
function register_post_types_payment()
{
    register_post_type('payment', [
        'label'               => null,
        'labels'              => [
            'name'               => __('Платеж', 'dwr-theme'),      // основное название для типа записи
            'singular_name'      => __('Платежи', 'dwr-theme'),                  // название для одной записи этого типа
            'add_new'            => __('Добавить платеж', 'dwr-theme'),         // для добавления новой записи
            'add_new_item'       => __('Добавление платежа', 'dwr-theme'),
            // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item'          => __('Редактирование платежа', 'dwr-theme'),   // для редактирования типа записи
            'new_item'           => __('Новый платеж', 'dwr-theme'),            // текст новой записи
            'view_item'          => __('Смотреть платеж', 'dwr-theme'),         // для просмотра записи этого типа.
            ...
            'menu_name'          => __('Платежи', 'dwr-theme'),      // название меню
        ],
        'description'         => '',
        'public'              => true,
        ...
        'rest_base'           => 'payment',               // $post_type. C WP 4.7
        'menu_position'       => null,
