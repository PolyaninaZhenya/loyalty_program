...
function create_taxonomy_program()
{
 ...
 */
add_action('init', 'register_post_types_program');
function register_post_types_program()
{
    register_post_type('program', [
        'label'               => null,
        'labels'              => [
            'name'               => __('Программа', 'dwr-theme'),      // основное название для типа записи
            'singular_name'      => __('Программа', 'dwr-theme'),                  // название для одной записи этого типа
            'add_new'            => __('Добавить программу', 'dwr-theme'),         // для добавления новой записи
            'add_new_item'       => __('Добавление программы', 'dwr-theme'),
            // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item'          => __('Редактирование программы', 'dwr-theme'),   // для редактирования типа записи
            'new_item'           => __('Новая программа', 'dwr-theme'),            // текст новой записи
            'view_item'          => __('Смотреть программу', 'dwr-theme'),         // для просмотра записи этого типа.
            'search_items'       => __('Искать программу', 'dwr-theme'),           // для поиска по этим типам записи
            ...
            'menu_name'          => __('Программы', 'dwr-theme'),      // название меню
        ],
        'description'         => '',
        'public'              => true,
